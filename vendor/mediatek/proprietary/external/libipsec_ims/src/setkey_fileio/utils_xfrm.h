...
extern int get_netmask(unsigned *val, const char *arg, int base);
...
extern int get_addr_ipv4(__u8 *ap, const char *cp);
extern int get_addr_1(inet_prefix *addr, const char *name, int family);
