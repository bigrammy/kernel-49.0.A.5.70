...
METHOD(peer_cfg_t, set_pcscf_restore, void,
	private_peer_cfg_t *this)
{
	this->pcscf_restore = TRUE;
}

METHOD(peer_cfg_t, set_is_emergency, void,
	private_peer_cfg_t *this)
{
	this->is_emergency = TRUE;
}

METHOD(peer_cfg_t, set_device_identity, void,
	private_peer_cfg_t *this)
{
	this->device_identity = TRUE;
}
							...
							identification_t *peer_id)
{
	...
	INIT(this,
		.public = {
			...
			.set_pcscf_restore = _set_pcscf_restore,
			.get_pcscf_restore = _get_pcscf_restore,
			.set_is_emergency = _set_is_emergency,
			.set_device_identity = _set_device_identity,
