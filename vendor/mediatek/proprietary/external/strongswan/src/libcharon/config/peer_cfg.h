...
struct peer_cfg_t {
	...
	*/
	...
	/**
	 * enable pcscf restore feature
	 */
	void (*set_pcscf_restore)(peer_cfg_t *this);

	/**
	 * enable emergency indication
	 */
	void (*set_is_emergency)(peer_cfg_t *this);

	/**
	 * enable device_identity feature
	 */
	void (*set_device_identity)(peer_cfg_t *this);
