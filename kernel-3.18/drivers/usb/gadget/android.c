...
/*[Arima_8103][bozhi_lin] apply SM32 Ranger sony usb pid vid: add charging only 20170630 begin*/
#if 1
#define KPOC_USB_VENDOR_ID 0x0FCE
#define KPOC_USB_PRODUCT_ID 0xE1F6
#else
#define KPOC_USB_VENDOR_ID 0x0E8D
#define KPOC_USB_PRODUCT_ID 0x20FF
#endif
/*[Arima_8103][bozhi_lin] 20170630 end*/
#endif
