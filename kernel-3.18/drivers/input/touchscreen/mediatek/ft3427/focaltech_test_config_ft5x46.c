...
/*[Arima_8100][bozhi_lin] touch aats test LCD noise implement 20170320 begin*/
	...
	g_stCfg_FT5X22_TestItem.LCD_NOISE_TEST = atoi(str);
...
/*[Arima_8100][bozhi_lin] touch aats test LCD noise implement 20170320 begin*/
	...
	g_stCfg_FT5X22_BasicThreshold.Lcd_Noise_MaxFrame = atoi(str);
	GetPrivateProfileString("Basic_Threshold","Lcd_Noise_Conficient","100",str,strIniFile);
	g_stCfg_FT5X22_BasicThreshold.Lcd_Noise_Conficient = atoi(str);
	GetPrivateProfileString("Basic_Threshold","Lcd_Noise_Mode","1",str,strIniFile);
	g_stCfg_FT5X22_BasicThreshold.Lcd_Noise_Noise_Mode = atoi(str);
	GetPrivateProfileString("Basic_Threshold","Lcd_Noise_MaxNgPoint","0",str,strIniFile);
	g_stCfg_FT5X22_BasicThreshold.Lcd_Noise_MaxNgPoint = atoi(str);
	GetPrivateProfileString("Basic_Threshold","Lcd_Noise_FrameNum","63",str,strIniFile);
	g_stCfg_FT5X22_BasicThreshold.Lcd_Noise_FrameNum = atoi(str);

	GetPrivateProfileString("Basic_Threshold","Lcd_Noise_SetFrequency","0",str,strIniFile);
	g_stCfg_FT5X22_BasicThreshold.Lcd_Noise_SetFrequency = atoi(str);
	GetPrivateProfileString("Basic_Threshold","Lcd_Noise_NoiseThresholdMode","0",str,strIniFile);
	g_stCfg_FT5X22_BasicThreshold.Lcd_Noise_NoiseThresholdMode = atoi(str);
	GetPrivateProfileString("Basic_Threshold","Lcd_Noise_NoiseCoefficient","200",str,strIniFile);
	g_stCfg_FT5X22_BasicThreshold.Lcd_Noise_NoiseCoefficient = atoi(str);
	GetPrivateProfileString("Basic_Threshold","Lcd_Noise_NoiseMax","50",str,strIniFile);
	g_stCfg_FT5X22_BasicThreshold.Lcd_Noise_NoiseMax = atoi(str);

	GetPrivateProfileString("Basic_Threshold","Check_Lcd_Noise_Continue_NG_Frame","0",str,strIniFile);
	g_stCfg_FT5X22_BasicThreshold.Lcd_Noise_Check_Continue_NG = atoi(str);
	GetPrivateProfileString("Basic_Threshold","Lcd_Noise_Continue_Conficient","0",str,strIniFile);
	g_stCfg_FT5X22_BasicThreshold.Lcd_Noise_Continue_Coefficient = atoi(str);
	GetPrivateProfileString("Basic_Threshold","Lcd_Noise_Continue_NG_Frame","0",str,strIniFile);
	g_stCfg_FT5X22_BasicThreshold.Lcd_Noise_Continue_NG_Frame = atoi(str);
/*[Arima_8100][bozhi_lin] 20170320 end*/
}
...
/*[Arima_8100][bozhi_lin] touch aats test LCD noise implement 20170320 begin*/
	//////////////////////////////////////////////////LCD_NOISE_TEST
	if( g_stCfg_FT5X22_TestItem.LCD_NOISE_TEST == 1)
	{
		g_stTestItem[0][g_TestItemNum].ItemCode = Code_FT5X22_LCD_NOISE_TEST;
		//g_stTestItem[0][g_TestItemNum].strItemName = g_strEnumTestItem_FT5X22[Code_FT5X22_LCD_NOISE_TEST];
		g_stTestItem[0][g_TestItemNum].TestNum = g_TestItemNum;
		g_stTestItem[0][g_TestItemNum].TestResult= RESULT_NULL;
		g_TestItemNum++;		
	}
