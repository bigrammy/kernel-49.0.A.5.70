...
/*[Arima_8100][bozhi_lin] RID003699 OVP warning message to end-user add swtich driver 20170321 begin*/
#include <linux/switch.h>
static struct switch_dev invalid_charger_data;
/*[Arima_8100][bozhi_lin] 20170321 end*/
...
/*[Arima_8100][bozhi_lin] set shutdown temperature from 60 degreeC to 63 degreeC 20161024 begin*/
#define BATTERY_SHUTDOWN_TEMP 63
/*[Arima_8100][bozhi_lin] 20161024 end*/
...
#if 0
CHARGER_TYPE First_Boot_CHR_Type = CHARGER_UNKNOWN;
#endif
...
/* Battery type name */
#define BATTERY_TYPE_NAME_SEND "1309-2675"
#define BATTERY_TYPE_NAME_TDK "1309-2682"
...
/*[Arima_8100][bozhi_lin] RID003588 Battery Health test in the Service Menu 20161115 begin*/
...
/*[Arima_8100][bozhi_lin] add battery voltage_now for check battery voltage 20161229 begin*/
	POWER_SUPPLY_PROP_VOLTAGE_OCV,
/*[Arima_8100][bozhi_lin] 20161229 end*/
/*[Arima_8100][bozhi_lin] add battery current_now for check charging current 20161228 begin*/
	POWER_SUPPLY_PROP_CURRENT_NOW,
/*[Arima_8100][bozhi_lin] 20161228 end*/
/*[Arima_8100][bozhi_lin] RID003588 Battery Health test in the Service Menu 20161124 begin*/
/*[Arima_8100][bozhi_lin] RID003588 Battery Health test in the Service Menu 20161115 begin*/
#if defined(CONFIG_CHARGING_SOFTCHARE3_0)
...
/*[Arima_8103][bozhi_lin] RID001102 Battery Care ver 1.0 for DD 20170622 begin*/
#if defined(CONFIG_STOP_CHARGING_IN_SMARTCHARGING)
	POWER_SUPPLY_PROP_smart_charging_activation,
	POWER_SUPPLY_PROP_smart_charging_interruption,
#endif
/*[Arima_8103][bozhi_lin] 20170622 end*/
};
...
/*[Arima_8100][bozhi_lin] fix sometimes detect cable out fail 20170407 begin*/
...
/*[Arima_8100][bozhi_lin] 20170407 end*/
...
/*[Arima_8100][bozhi_lin] RID003588 Battery Health test in the Service Menu 20161115 begin*/
	...
	case POWER_SUPPLY_PROP_CHARGE_FULL_DESIGN:
		/* Using the Arima patch not use qns patch begin*/
		//#ifdef CONFIG_CHARGER_QNS
		//val->intval = battery_meter_get_design_qmax();
		//#else
		val->intval = data->BAT_CHARGE_FULL_DESIGN;
		//#endif
		/* Using the Arima patch not use qns patch end*/
		break;
	case POWER_SUPPLY_PROP_CHARGE_FULL:
		/* Using the Arima patch not use qns patch start*/
		//#ifdef CONFIG_CHARGER_QNS
		//val->intval = battery_meter_get_qmax();
		//#else
		val->intval = data->BAT_CHARGE_FULL;
		//#endif
		/* Using the Arima patch not use qns patch end*/
		break;
#endif
...
/*[Arima_8100][bozhi_lin] add fake soc for test purpose 20170103 begin*/
		...
		if (BMT_status.FAKE_UI_SOC != -1) {
			val->intval = BMT_status.FAKE_UI_SOC;
		} else {
...
/*[Arima_8100][bozhi_lin] FP22589: Battery Swelling mitigation for retail demo units 20161027 begin*/
	...
	case POWER_SUPPLY_PROP_enable_llk:
		val->intval = batt_cust_data.stop_charging_in_demoapp;
		break;
#endif
/*[Arima_8100][bozhi_lin] 20161027 end*/
...
/*[Arima_8100][bozhi_lin] RID001582 - Soft charge 3.0 20161116 begin*/
#if defined(CONFIG_CHARGING_SOFTCHARE3_0)
	case POWER_SUPPLY_PROP_sc3_40_init_time:
		val->intval = BMT_status.SOFTCHARE3_0_40_init_time;
		break;
	case POWER_SUPPLY_PROP_sc3_40_charging_time:
		val->intval = BMT_status.SOFTCHARE3_0_40_charging_time;
		break;
	case POWER_SUPPLY_PROP_sc3_30_init_time:
		val->intval = BMT_status.SOFTCHARE3_0_30_init_time;
		break;
	case POWER_SUPPLY_PROP_sc3_30_charging_time:
		val->intval = BMT_status.SOFTCHARE3_0_30_charging_time;
		break;
	case POWER_SUPPLY_PROP_sc3_20_init_time:
		val->intval = BMT_status.SOFTCHARE3_0_20_init_time;
		break;
	case POWER_SUPPLY_PROP_sc3_20_charging_time:
		val->intval = BMT_status.SOFTCHARE3_0_20_charging_time;
		break;
	case POWER_SUPPLY_PROP_sc3_fcc_mah_0:
		val->intval = BMT_status.SOFTCHARE3_0_aged_fcc_mah[0];
		break;
	case POWER_SUPPLY_PROP_sc3_fcc_mah_1:
		val->intval = BMT_status.SOFTCHARE3_0_aged_fcc_mah[1];
		break;
	case POWER_SUPPLY_PROP_sc3_fcc_mah_2:
		val->intval = BMT_status.SOFTCHARE3_0_aged_fcc_mah[2];
		break;
	case POWER_SUPPLY_PROP_sc3_fcc_mah_3:
		val->intval = BMT_status.SOFTCHARE3_0_aged_fcc_mah[3];
		break;
	case POWER_SUPPLY_PROP_sc3_fcc_mah_4:
		val->intval = BMT_status.SOFTCHARE3_0_aged_fcc_mah[4];
		break;
#endif
/*[Arima_8100][bozhi_lin] 20161116 end*/
/*[Arima_8100][bozhi_lin] 20161124 end*/
/*[Arima_8100][bozhi_lin] 20161130 end*/
	...
	case POWER_SUPPLY_PROP_BATTERY_TYPE:
		...
		if (id == 0)
			val->strval = BATTERY_TYPE_NAME_TDK;
		else if (id == 1)
...
/*[Arima_8103][bozhi_lin] RID001102 Battery Care ver 1.0 for DD 20170622 begin*/
	...
	case POWER_SUPPLY_PROP_smart_charging_activation:
		val->intval = batt_cust_data.enable_smartcharging;
		break;
	case POWER_SUPPLY_PROP_smart_charging_interruption:
		val->intval = batt_cust_data.stop_charging_in_smartcharging;
		break;
#endif
/*[Arima_8103][bozhi_lin] 20170622 end*/
...
#if defined(CONFIG_STOP_CHARGING_IN_DEMOAPP)
	case POWER_SUPPLY_PROP_enable_llk:
		batt_cust_data.stop_charging_in_demoapp = val->intval;
		break;
#endif

#if defined(CONFIG_CHARGING_SOFTCHARE3_0)
	case POWER_SUPPLY_PROP_sc3_40_init_time:
		BMT_status.SOFTCHARE3_0_40_init_time = val->intval;
		break;
	case POWER_SUPPLY_PROP_sc3_30_init_time:
		BMT_status.SOFTCHARE3_0_30_init_time = val->intval;
		break;
	case POWER_SUPPLY_PROP_sc3_20_init_time:
		BMT_status.SOFTCHARE3_0_20_init_time = val->intval;
		break;
/*[Arima_8100][bozhi_lin] RID003588 Battery Health test in the Service Menu 20161130 begin*/
/*[Arima_8100][bozhi_lin] RID003588 Battery Health test in the Service Menu 20161124 begin*/
	case POWER_SUPPLY_PROP_sc3_fcc_mah_0:
		BMT_status.SOFTCHARE3_0_fcc_mah[0] = val->intval;
		BMT_status.SOFTCHARE3_0_aged_fcc_mah[0] = val->intval;
		break;
	case POWER_SUPPLY_PROP_sc3_fcc_mah_1:
		BMT_status.SOFTCHARE3_0_fcc_mah[1] = val->intval;
		BMT_status.SOFTCHARE3_0_aged_fcc_mah[1] = val->intval;
		break;
	case POWER_SUPPLY_PROP_sc3_fcc_mah_2:
		BMT_status.SOFTCHARE3_0_fcc_mah[2] = val->intval;
		BMT_status.SOFTCHARE3_0_aged_fcc_mah[2] = val->intval;
		break;
	case POWER_SUPPLY_PROP_sc3_fcc_mah_3:
		BMT_status.SOFTCHARE3_0_fcc_mah[3] = val->intval;
		BMT_status.SOFTCHARE3_0_aged_fcc_mah[3] = val->intval;
		break;
	case POWER_SUPPLY_PROP_sc3_fcc_mah_4:
		BMT_status.SOFTCHARE3_0_fcc_mah[4] = val->intval;
		BMT_status.SOFTCHARE3_0_aged_fcc_mah[4] = val->intval;
		break;
/*[Arima_8100][bozhi_lin] 20161124 end*/
/*[Arima_8100][bozhi_lin] 20161130 end*/
#endif
...
#ifdef CONFIG_CHARGER_QNS
	case POWER_SUPPLY_PROP_MAX_CHARGE_CURRENT:
/*[Arima_8103][bozhi_lin] enable Qnovo in all build and add qns_disable file node for temp disable Qnovo 20170824 begin*/
		if (((BMT_status.is_qns_disable) == KAL_FALSE) && ((data->qns_max_charge_current) != (val->intval))){
			battery_log(BAT_LOG_CRTI, "set qns_current from %dmA to %dmA\r\n", data->qns_max_charge_current, val->intval);
		}
/*[Arima_8103][bozhi_lin] 20170824 end*/
	 	data->qns_max_charge_current = val->intval;
 		break;
#endif

/*[Arima_8103][bozhi_lin] RID001102 Battery Care ver 1.0 for DD add charging suspension time 20170629 begin*/
/*[Arima_8103][bozhi_lin] RID001102 Battery Care ver 1.0 for DD 20170622 begin*/
#if defined(CONFIG_STOP_CHARGING_IN_SMARTCHARGING)
	case POWER_SUPPLY_PROP_smart_charging_activation:
		batt_cust_data.enable_smartcharging = val->intval;
		break;
	case POWER_SUPPLY_PROP_smart_charging_interruption:
		batt_cust_data.stop_charging_in_smartcharging = val->intval;
		BMT_status.bat_in_smartcharging_count_state = KAL_FALSE;
		BMT_status.SMARTCHARGING_charging_time = 0;
		break;
#endif
/*[Arima_8103][bozhi_lin] 20170622 end*/
/*[Arima_8103][bozhi_lin] 20170629 end*/
...
/* CC: modify to have a full power supply status */
	...
	.BAT_CAPACITY = -1,
#else
/*[Arima_8100][bozhi_lin] fix battery capacity will show 50% until charge driver not ready 20170106 begin*/
#if 1
	.BAT_CAPACITY = -1,
#else
	.BAT_CAPACITY = 50,
#endif
/*[Arima_8100][bozhi_lin] 20170106 end*/
#endif
	.BAT_batt_vol = 0,
	.BAT_batt_temp = 0,
	/* Dual battery */
...
{
/*[Arima_8103][bozhi_lin] enable Qnovo in all build and add qns_disable file node for temp disable Qnovo 20170824 begin*/
/*[Arima_8100][bozhi_lin] for ESTA low battery, disable Qnovo in userdebug or eng build 20170412 begin*/
/*[Arima_8100][bozhi_lin] enable Qnovo in all build 20170309 begin*/
/*[Arima_8100][bozhi_lin] for ESTA low battery, disable Qnovo in userdebug or eng build 20170109 begin*/
//#if defined(USER_BUILD)
#if 1
	if (battery_main.BAT_STATUS  != POWER_SUPPLY_STATUS_CHARGING) {
		battery_main.qns_max_charge_current = 0;
	}
	if ((BMT_status.is_qns_disable) == KAL_TRUE) {
		battery_main.qns_max_charge_current = 0;
	}
/*[Arima_8103][bozhi_lin] fix qnovo is not work 20171101 begin*/
/*[Arima_8103][bozhi_lin] disable Qnovo when enter retail demo mode 20170907 begin*/
	if ((batt_cust_data.stop_charging_in_demoapp) == 1) {
		battery_main.qns_max_charge_current = 0;
	}
/*[Arima_8103][bozhi_lin] 20170907 end*/
/*[Arima_8103][bozhi_lin] 20171101 end*/
...
/*[Arima_8100][bozhi_lin] 20170309 end*/
/*[Arima_8100][bozhi_lin] 20170412 end*/
/*[Arima_8103][bozhi_lin] 20170824 end*/
}
#endif
#if !defined(CONFIG_POWER_EXT)
...
/*[Arima_8100][bozhi_lin] add fake soc for test purpose 20170103 begin*/
static ssize_t show_FAKE_UI_SOC(struct device *dev, struct device_attribute *attr, char *buf)
{
	battery_log(BAT_LOG_CRTI, "[B]%s(%d): BMT_status.FAKE_UI_SOC = %d\n",
		__func__, __LINE__, BMT_status.FAKE_UI_SOC);

	return sprintf(buf, "%d\n", BMT_status.FAKE_UI_SOC);
}

static ssize_t store_FAKE_UI_SOC(struct device *dev, struct device_attribute *attr,
				  const char *buf, size_t size)
{
	int fake_ui_soc;
	if (kstrtouint(buf, 10, &fake_ui_soc) == 0) {
		if (fake_ui_soc > 100) {
			BMT_status.FAKE_UI_SOC = 100;
		} else if (fake_ui_soc > 0) {
			BMT_status.FAKE_UI_SOC = fake_ui_soc;
		} else {
			BMT_status.FAKE_UI_SOC = -1;
		}
		battery_log(BAT_LOG_CRTI, "[B]%s(%d): BMT_status.FAKE_UI_SOC = %d\n", __func__, __LINE__, BMT_status.FAKE_UI_SOC);
	} else {
		battery_log(BAT_LOG_CRTI, "format error\n");
	}

	return size;
}

static DEVICE_ATTR(FAKE_UI_SOC, 0664, show_FAKE_UI_SOC, store_FAKE_UI_SOC);
/*[Arima_8100][bozhi_lin] 20170103 end*/

/*[Arima_8103][bozhi_lin] add reset file node for battery capacity reset 20170713 begin*/
static ssize_t show_RTC_RESET(struct device *dev, struct device_attribute *attr, char *buf)
{
	battery_log(BAT_LOG_CRTI, "[B]%s(%d): BMT_status.is_rtc_reset = %d\n",
		__func__, __LINE__, BMT_status.is_rtc_reset);

	return sprintf(buf, "%d\n", BMT_status.is_rtc_reset);
}

static ssize_t store_RTC_RESET(struct device *dev, struct device_attribute *attr,
				  const char *buf, size_t size)
{
	int is_rtc_reset;
	if (kstrtouint(buf, 10, &is_rtc_reset) == 0) {
		if (is_rtc_reset == 1) {
			BMT_status.is_rtc_reset = KAL_TRUE;
			set_rtc_spare_fg_value(0);
		} else {
			BMT_status.is_rtc_reset = KAL_FALSE;
		}
		battery_log(BAT_LOG_CRTI, "[B]%s(%d): BMT_status.is_rtc_reset = %d\n", __func__, __LINE__, BMT_status.is_rtc_reset);
	} else {
		battery_log(BAT_LOG_CRTI, "format error\n");
...
static DEVICE_ATTR(RTC_RESET, 0664, show_RTC_RESET, store_RTC_RESET);
/*[Arima_8103][bozhi_lin] 20170713 end*/

/*[Arima_8103][bozhi_lin] enable Qnovo in all build and add qns_disable file node for temp disable Qnovo 20170824 begin*/
static ssize_t show_QNS_disable(struct device *dev, struct device_attribute *attr, char *buf)
{
	battery_log(BAT_LOG_CRTI, "[B]%s(%d): BMT_status.is_qns_disable = %d\n",
		__func__, __LINE__, BMT_status.is_qns_disable);

	return sprintf(buf, "%d\n", BMT_status.is_qns_disable);
}

static ssize_t store_QNS_disable(struct device *dev, struct device_attribute *attr,
				  const char *buf, size_t size)
{
	int is_qns_disable;
	if (kstrtouint(buf, 10, &is_qns_disable) == 0) {
		if (is_qns_disable == 1) {
			BMT_status.is_qns_disable = KAL_TRUE;
		} else {
			BMT_status.is_qns_disable = KAL_FALSE;
		}
		battery_log(BAT_LOG_CRTI, "[B]%s(%d): BMT_status.is_qns_disable = %d\n", __func__, __LINE__, BMT_status.is_qns_disable);
	} else {
		battery_log(BAT_LOG_CRTI, "format error\n");
...
static DEVICE_ATTR(QNS_disable, 0664, show_QNS_disable, store_QNS_disable);
/*[Arima_8103][bozhi_lin] 20170824 end*/

/*[Arima_8103][bozhi_lin] add property to enable disable charging for run in test 20170920 begin*/
static ssize_t show_Charging_disable(struct device *dev, struct device_attribute *attr, char *buf)
{
	battery_log(BAT_LOG_CRTI, "[B]%s(%d): cmd_discharging = %d\n",
		__func__, __LINE__, cmd_discharging);
...
static ssize_t store_Charging_disable(struct device *dev, struct device_attribute *attr,
				  const char *buf, size_t size)
{
	int is_charging_disable;
	if (kstrtouint(buf, 10, &is_charging_disable) == 0) {
		if (is_charging_disable == 1) {
			cmd_discharging = 1;
		} else {
			cmd_discharging = 0;
		}
...
/*[Arima_8103][bozhi_lin] 20170920 end*/
...
/*[Arima_8100][bozhi_lin] RID003588 Battery Health test in the Service Menu 20161115 begin*/
#if defined(CONFIG_CHARGING_SOFTCHARE3_0)
	bat_data->BAT_CHARGE_FULL_DESIGN = BATTERY_DESIGN_CAPACITY;
	if (BMT_status.SOFTCHARE3_0_average_fcc_mah == 0) {
		bat_data->BAT_CHARGE_FULL = BATTERY_DESIGN_CAPACITY;
	} else {
		bat_data->BAT_CHARGE_FULL = BMT_status.SOFTCHARE3_0_average_fcc_mah;
	}
#endif
/*[Arima_8100][bozhi_lin] 20161115 end*/
/*[Arima_8100][bozhi_lin] 20161124 end*/
...
/*[Arima_8103][bozhi_lin] RID001102 Battery Care ver 1.0 for DD 20170622 begin*/
/*[Arima_8100][bozhi_lin] FP22589: Battery Swelling mitigation for retail demo units 20161027 begin*/
#if defined(CONFIG_STOP_CHARGING_IN_DEMOAPP) || defined(CONFIG_STOP_CHARGING_IN_SMARTCHARGING)
	if ((BMT_status.charger_exist == KAL_TRUE) && (BMT_status.bat_charging_state != CHR_ERROR)
		 && (BMT_status.bat_charging_state != CHR_HOLD_DEMO)) {
#else
	if ((BMT_status.charger_exist == KAL_TRUE) && (BMT_status.bat_charging_state != CHR_ERROR)) {
#endif
/*[Arima_8100][bozhi_lin] 20161027 end*/
...
/*[Arima_8100][bozhi_lin] charging maintenance implement 20161102 begin*/
	...
	if ((BMT_status.bat_full == KAL_TRUE) && (BMT_status.bat_in_maintain_state == KAL_FALSE))
		return KAL_TRUE;
	else
		return KAL_FALSE;
#else
...
/*[Arima_8100][bozhi_lin] charging maintenance implement 20161102 begin*/
#if defined(CHARGING_MAINTAIN)
	static kal_bool previous_in_maintain_state = KAL_FALSE;
#else
...
/*[Arima_8100][bozhi_lin] charging maintenance implement 20161102 begin*/
#if defined(CHARGING_MAINTAIN)
			} else if ((previous_in_maintain_state == KAL_FALSE)
...
/*[Arima_8100][bozhi_lin] RID003699 OVP warning message to end-user 20170320 begin*/
	unsigned int vinovpi;
	unsigned int is_charging;

	battery_charging_control(CHARGING_CMD_GET_VINOVPI, &vinovpi);
	battery_charging_control(CHARGING_CMD_GET_IS_CHARGING, &is_charging);
...
/*[Arima_8100][bozhi_lin] RID003699 OVP warning message to end-user 20170320 begin*/
#if 1
		if ((BMT_status.charger_vol >= batt_cust_data.v_charger_max) && (vinovpi || !is_charging)) {
#else
...
/*[Arima_8100][bozhi_lin] only user build can enable 100 hours usb charging timer 20161222 begin*/
#if defined(USER_BUILD)
			status = PMU_STATUS_FAIL;
#else
			if (BMT_status.charging_timer == USB_MAX_CHARGING_TIME) {
				battery_log(BAT_LOG_CRTI, "[B]%s(%d): not user build, still charging\n", __func__, __LINE__);
...
/*[Arima_8100][bozhi_lin] FP22589: Battery Swelling mitigation for retail demo units 20161027 begin*/
#if defined(CONFIG_STOP_CHARGING_IN_DEMOAPP)
static PMU_STATUS mt_battery_CheckBatteryCapacity(void)
{
	PMU_STATUS status = PMU_STATUS_OK;

	if (BMT_status.UI_SOC2 >= DEMOAPP_STOPCHARGE_SOC) {
		status = PMU_STATUS_FAIL;
	}
...
/*[Arima_8103][bozhi_lin] RID001102 Battery Care ver 1.0 for DD 20170622 begin*/
#if defined(CONFIG_STOP_CHARGING_IN_SMARTCHARGING)
static PMU_STATUS mt_battery_CheckSmartCharging(void)
{
	PMU_STATUS status = PMU_STATUS_OK;

	if (batt_cust_data.enable_smartcharging == 1) {
		if (batt_cust_data.stop_charging_in_smartcharging == 1) {
			status = PMU_STATUS_FAIL;
		}
	}
...
#if defined(CONFIG_STOP_CHARGING_IN_DEMOAPP)
	if (batt_cust_data.stop_charging_in_demoapp == 1) {
		if (mt_battery_CheckBatteryCapacity() != PMU_STATUS_OK) {
			BMT_status.bat_charging_state = CHR_HOLD_DEMO;
			return;
		}
	} else if (batt_cust_data.stop_charging_in_demoapp == 0) {
		BMT_status.bat_charging_state = CHR_PRE;
		batt_cust_data.stop_charging_in_demoapp = -1;
	}
#endif
/*[Arima_8100][bozhi_lin] 20161027 end*/
...
#if defined(CONFIG_STOP_CHARGING_IN_SMARTCHARGING)
	if (batt_cust_data.enable_smartcharging == 1) {
		if (mt_battery_CheckSmartCharging() != PMU_STATUS_OK) {
			BMT_status.bat_charging_state = CHR_HOLD_SMARTCHARGING;
			return;
		}
	}
#endif
...
/*[Arima_8100][bozhi_lin] show battery over temperature notify only with cable in 20170207 begin*/
#if 1
	if ((BMT_status.temperature >= TEMP_POS_55_THRESHOLD) && (BMT_status.charger_exist)) {
#else
	if (BMT_status.temperature >= batt_cust_data.max_charge_temperature) {
#endif
/*[Arima_8100][bozhi_lin] 20170207 end*/
...
/*[Arima_8100][bozhi_lin] show battery over temperature notify only with cable in 20170207 begin*/
#if 1
	else if ((BMT_status.temperature < TEMP_POS_5_THRESHOLD) && (BMT_status.charger_exist)) {
#else
...
/*[Arima_8100][bozhi_lin] RID003699 OVP warning message to end-user add swtich driver 20170321 begin*/
#if 1
	if (invalid_charger_data.state != 0)
#else
...
#else
/*[Arima_8100][bozhi_lin] set shutdown temperature from 60 degreeC to 63 degreeC 20161024 begin*/
#if defined(BATTERY_SHUTDOWN_TEMP)
		if (BMT_status.temperature >= BATTERY_SHUTDOWN_TEMP) {
#else
...
/*[Arima_8100][bozhi_lin] set shutdown temperature from 60 degreeC to 63 degreeC 20161024 begin*/
					...
					battery_log(BAT_LOG_CRTI,
						    ...
						    BMT_status.temperature, BATTERY_SHUTDOWN_TEMP);
#else
					battery_log(BAT_LOG_CRTI,
...
#else
#if !defined(CONFIG_MTK_DUAL_INPUT_CHARGER_SUPPORT)
/*[Arima_8100][bozhi_lin] follow FAQ15039, detect again when detect as nono-stardard charger 20170329 begin*/
/*[Arima_8100][bozhi_lin] fix NONSTANDARD_CHARGER & CHARGING_HOST will re-detcet in off-charging mode cause reboot 20170227 begin*/
/*[Arima_8100][bozhi_lin] follow FAQ15039, detect again when detect as nono-stardard charger 20170119 begin*/
#if 1
	if ((BMT_status.charger_type == CHARGER_UNKNOWN) || (BMT_status.charger_type == NONSTANDARD_CHARGER)) {
#else
	if (BMT_status.charger_type == CHARGER_UNKNOWN) {
#endif
/*[Arima_8100][bozhi_lin] 20170119 end*/
/*[Arima_8100][bozhi_lin] 20170227 end*/
...
/*[Arima_8100][bozhi_lin] add CHARGING_HOST to set USB timer to 100 hours 20161208 begin*/
/*[Arima_8100][bozhi_lin] set AC timer to 6 hours and USB to 100 hours 20161101 begin*/
		if ((BMT_status.charger_type == STANDARD_HOST) || (BMT_status.charger_type == CHARGING_HOST)) {
			BMT_status.charging_timer = USB_MAX_CHARGING_TIME;
		} else {
			BMT_status.charging_timer = AC_MAX_CHARGING_TIME;
		}
/*[Arima_8100][bozhi_lin] 20161101 end*/
...
/*[Arima_8100][bozhi_lin] RID001582 - Soft charge 3.0 20161116 begin*/
#if 0
		BMT_status.SOFTCHARE3_0_total_charging_time = 0;
		BMT_status.SOFTCHARE3_0_40_init_time = 0;
		BMT_status.SOFTCHARE3_0_40_charging_time = 0;
		BMT_status.SOFTCHARE3_0_30_init_time = 0;
		BMT_status.SOFTCHARE3_0_30_charging_time = 0;
		BMT_status.SOFTCHARE3_0_20_init_time = 0;
		BMT_status.SOFTCHARE3_0_20_charging_time = 0;
#endif
/*[Arima_8100][bozhi_lin] 20161116 end*/
/*[Arima_8100][bozhi_lin] 20161123 end*/
/*[Arima_8103][bozhi_lin] RID001102 Battery Care ver 1.0 for DD add charging suspension time 20170629 begin*/
#if defined(CONFIG_STOP_CHARGING_IN_SMARTCHARGING)
		BMT_status.bat_in_smartcharging_count_state = KAL_TRUE;
#endif
/*[Arima_8103][bozhi_lin] 20170629 end*/
		BMT_status.bat_charging_state = CHR_PRE;
...
/*[Arima_8100][bozhi_lin] fix CHARGING_HOST will power-off before enter off-charging mode 20170306 begin*/
/*[Arima_8100][bozhi_lin] fix CHARGING_HOST will power-off before enter off-charging mode 20170302 begin*/
/*[Arima_8100][bozhi_lin] fix NONSTANDARD_CHARGER & CHARGING_HOST will re-detcet in off-charging mode cause reboot 20170227 begin*/
#if 0
...
/*[Arima_8103][bozhi_lin] RID001102 Battery Care ver 1.0 for DD 20170622 begin*/
#if defined(CONFIG_STOP_CHARGING_IN_SMARTCHARGING)
	batt_cust_data.enable_smartcharging = 0;
	batt_cust_data.stop_charging_in_smartcharging = 0;
#endif
/*[Arima_8103][bozhi_lin] 20170622 end*/
...
/*[Arima_8100][bozhi_lin] for ESTA low battery, set usb charging current to 1A in userdebug or eng build 20161227 begin*/
#if defined(USER_BUILD)
	batt_cust_data.usb_charger_current_configured = USB_CHARGER_CURRENT_CONFIGURED;
#else
	batt_cust_data.usb_charger_current_configured = CHARGE_CURRENT_1000_00_MA;
#endif
/*[Arima_8100][bozhi_lin] 20161227 end*/
#endif
...
#else
	batt_cust_data.charging_host_charger_current = CHARGE_CURRENT_1000_00_MA;
#endif
/*[Arima_8100][bozhi_lin] 20161227 end*/
#endif
...
/*[Arima_8100][bozhi_lin] add fake soc for test purpose 20170103 begin*/
		ret_device_file = device_create_file(&(dev->dev), &dev_attr_FAKE_UI_SOC);
/*[Arima_8100][bozhi_lin] 20170103 end*/
/*[Arima_8103][bozhi_lin] add reset file node for battery capacity reset 20170713 begin*/
		ret_device_file = device_create_file(&(dev->dev), &dev_attr_RTC_RESET);
/*[Arima_8103][bozhi_lin] 20170713 end*/
/*[Arima_8103][bozhi_lin] enable Qnovo in all build and add qns_disable file node for temp disable Qnovo 20170824 begin*/
		ret_device_file = device_create_file(&(dev->dev), &dev_attr_QNS_disable);
/*[Arima_8103][bozhi_lin] 20170824 end*/
/*[Arima_8103][bozhi_lin] add property to enable disable charging for run in test 20170920 begin*/
...
/*[Arima_8100][bozhi_lin] RID003699 OVP warning message to end-user add swtich driver 20170321 begin*/
	...
	ret = switch_dev_register(&invalid_charger_data);
