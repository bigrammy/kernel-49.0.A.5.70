...
#define SMARTCHARGING_CHARGING_SUSPENSION_EXPIRED_TIME		30 * 60 // 30 minutes
#endif
/*[Arima_8103][bozhi_lin] 20170629 end*/

/*[Arima_8100][bozhi_lin] RID003743 - Soft charge 3.1 change from 100h_250h to 50h_100h 20171222 begin*/
/*[Arima_8100][bozhi_lin] RID003743 - Soft charge 3.1 20170725 begin*/
/*[Arima_8100][bozhi_lin] RID001582 - Soft charge 3.0 20161116 begin*/
#if defined(CONFIG_CHARGING_SOFTCHARE3_0)
#define SOFTCHARE3_1_ENABLE
#if defined(SOFTCHARE3_1_ENABLE)
#define V_SOFTCHARE3_0_THRES	4290
...
#define SOFTCHARE3_0_TOTAL_CHARGING_TIME_STEP1	50 * 60 * 60 // 50 hours
#define SOFTCHARE3_0_TEMP_POS_40_FACTOR_STEP1	(126 / 100) //1.26
#define SOFTCHARE3_0_TEMP_POS_30_FACTOR_STEP1	(195 / 100) //1.95
#define SOFTCHARE3_0_TEMP_POS_20_FACTOR_STEP1	(486 / 100) //4.86

#define SOFTCHARE3_0_TOTAL_CHARGING_TIME_STEP2	100 * 60 * 60 // 100 hours
#define SOFTCHARE3_0_TEMP_POS_40_FACTOR_STEP2	(140 / 100) //1.40
#define SOFTCHARE3_0_TEMP_POS_30_FACTOR_STEP2	(216 / 100) //2.16
#define SOFTCHARE3_0_TEMP_POS_20_FACTOR_STEP2	(541 / 100) //5.41
#else
...
/*[Arima_8100][bozhi_lin] 20170725 end*/
/*[Arima_8100][bozhi_lin] 20171222 end*/
...
BATTERY_VOLTAGE_ENUM g_cv_voltage = BATTERY_VOLT_04_370000_V;
#else
...
/*[Arima_8100][bozhi_lin] set battery cv voltage to 4.35V 20161006 begin*/
		if (batt_cust_data.high_battery_voltage_support)
			cv_voltage = BATTERY_VOLT_04_370000_V;
		else
...
static void mtk_select_ichg_aicr(void)
{
   ...
   int qns_current = battery_get_qns_current() * 100;
	...
	if (get_usb_current_unlimited()) {
		...
		select_charging_current();
/*[Arima_8103][bozhi_lin] disable bcct to set lower charging current 20170510 begin*/
...
/*[Arima_8100][bozhi_lin] 20170111 end*/
		...
		/*[Arima_8100][bozhi_lin] RID003743 - Soft charge 3.1 20170807 begin*/
		/*[Arima_8100][bozhi_lin] RID003743 - Soft charge 3.1 20170725 begin*/
		#if defined(SOFTCHARE3_1_ENABLE)
			if (BMT_status.SOFTCHARE3_0_total_charging_time > SOFTCHARE3_0_TOTAL_CHARGING_TIME_STEP2) {
				cv_voltage = BATTERY_VOLT_04_330000_V;
			} else if (BMT_status.SOFTCHARE3_0_total_charging_time > SOFTCHARE3_0_TOTAL_CHARGING_TIME_STEP1) {
		...
		#endif
		/*[Arima_8100][bozhi_lin] 20170725 end*/
		/*[Arima_8100][bozhi_lin] 20170807 end*/
			/*[Arima_8100][bozhi_lin] RID001972 - Soft charge version 1.0 20161124 begin*/
...
/*[Arima_8100][bozhi_lin] 20161102 end*/
	...
	BMT_status.TOPOFF_charging_time = 0;
/*[Arima_8103][bozhi_lin] re-set charging timer when battery capacity reach 100 20170719 begin*/
#if 1
	...
	BMT_status.total_charging_time += BAT_TASK_PERIOD;
#endif
/*[Arima_8103][bozhi_lin] 20170719 end*/
/*[Arima_8100][bozhi_lin] charging maintenance implement 20161102 begin*/
#if defined(CHARGING_MAINTAIN)
	BMT_status.MAINTAIN_charging_time = 0;
...
//Step1: After 100h progress, 4.380V a 4.357V
//a). 20deg.C~30deg.C & >4.29V (Accelerated factor : 4.86)
//b). 30deg.C~40deg.C & >4.29V (Accelerated factor : 1.95)
//c). >40deg.C        & >4.29V (Accelerated factor : 1.26)
//a) + b) + c) = 100[hour], then charging voltage 4.37V to 4.35V
//Step2: After 250h progress, 4.357V a 4.335V
//a). 20deg.C~30deg.C & >4.29V (Accelerated factor : 5.41)
//b). 30deg.C~40deg.C & >4.29V (Accelerated factor : 2.16)
//c). >40deg.C        & >4.29V (Accelerated factor : 1.40)
//a) + b) + c) = 100[hour], then charging voltage 4.375 to 4.33V
	if (BMT_status.bat_vol > V_SOFTCHARE3_0_THRES) {
		...
		BMT_status.SOFTCHARE3_0_total_charging_time =
			((BMT_status.SOFTCHARE3_0_40_init_time + BMT_status.SOFTCHARE3_0_40_charging_time) / SOFTCHARE3_0_TEMP_POS_40_FACTOR_STEP1) +
			((BMT_status.SOFTCHARE3_0_30_init_time + BMT_status.SOFTCHARE3_0_30_charging_time) / SOFTCHARE3_0_TEMP_POS_30_FACTOR_STEP1) +
			((BMT_status.SOFTCHARE3_0_20_init_time + BMT_status.SOFTCHARE3_0_20_charging_time) / SOFTCHARE3_0_TEMP_POS_20_FACTOR_STEP1);

		if (BMT_status.SOFTCHARE3_0_total_charging_time > SOFTCHARE3_0_TOTAL_CHARGING_TIME_STEP1) {
			BMT_status.SOFTCHARE3_0_total_charging_time =
				((BMT_status.SOFTCHARE3_0_40_init_time + BMT_status.SOFTCHARE3_0_40_charging_time) / SOFTCHARE3_0_TEMP_POS_40_FACTOR_STEP2) +
				((BMT_status.SOFTCHARE3_0_30_init_time + BMT_status.SOFTCHARE3_0_30_charging_time) / SOFTCHARE3_0_TEMP_POS_30_FACTOR_STEP2) +
				((BMT_status.SOFTCHARE3_0_20_init_time + BMT_status.SOFTCHARE3_0_20_charging_time) / SOFTCHARE3_0_TEMP_POS_20_FACTOR_STEP2);

			if (BMT_status.SOFTCHARE3_0_total_charging_time <= SOFTCHARE3_0_TOTAL_CHARGING_TIME_STEP1) {
				BMT_status.SOFTCHARE3_0_total_charging_time = (SOFTCHARE3_0_TOTAL_CHARGING_TIME_STEP1 + 1);
			}
		}
	}
#else
...
PMU_STATUS BAT_BatteryHoldDemoAction(void)
{
	...
	if (batt_cust_data.stop_charging_in_demoapp) {
		if (BMT_status.UI_SOC2 < DEMOAPP_RECHARGE_SOC) {
			BMT_status.bat_charging_state = CHR_CC;
/*[Arima_8103][bozhi_lin] reset charging timer once enter demo mode 20170926 begin*/
			BMT_status.total_charging_time = 0;
			BMT_status.CC_charging_time = 0;
/*[Arima_8103][bozhi_lin] 20170926 end*/
...
#if defined(CONFIG_STOP_CHARGING_IN_SMARTCHARGING)
PMU_STATUS BAT_BatteryHoldSmartChargingAction(void)
{
	unsigned int charging_enable;

	battery_log(BAT_LOG_CRTI, "[BATTERY] Hold Smart Charging mode, time=%d\n",
		    BMT_status.SMARTCHARGING_charging_time);

	if (batt_cust_data.enable_smartcharging == 1) {
		if (batt_cust_data.stop_charging_in_smartcharging == 0) {
			BMT_status.bat_charging_state = CHR_CC;
			battery_log(BAT_LOG_CRTI, "[BATTERY] Exit Hold Smart Charging mode and Enter CC mode !!\n\r");
		} else if (batt_cust_data.stop_charging_in_smartcharging == 1) {
			if (BMT_status.bat_in_smartcharging_count_state == KAL_TRUE) {
				BMT_status.SMARTCHARGING_charging_time += BAT_TASK_PERIOD;
				if (BMT_status.SMARTCHARGING_charging_time > SMARTCHARGING_CHARGING_SUSPENSION_EXPIRED_TIME) {
					batt_cust_data.stop_charging_in_smartcharging = 0;
					BMT_status.bat_charging_state = CHR_CC;
					battery_log(BAT_LOG_CRTI, "[BATTERY] SUSPENSION TIME EXPIRED! Exit Hold Smart Charging mode and Enter CC mode !!\n\r");
				}
			}
		}
	}
...
/*[Arima_8103][bozhi_lin] RID001102 Battery Care ver 1.0 for DD 20170622 begin*/
#if defined(CONFIG_STOP_CHARGING_IN_SMARTCHARGING)
	case CHR_HOLD_SMARTCHARGING:
		BAT_BatteryHoldSmartChargingAction();
		break;
#endif
/*[Arima_8103][bozhi_lin] 20170622 end*/
