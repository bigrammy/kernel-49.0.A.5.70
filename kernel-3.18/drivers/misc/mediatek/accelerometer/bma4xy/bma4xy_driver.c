...
#if 1
	GSE_FUN();
//<--[SM32][Sensors][JasonHsing] Change G-sensor pin config for SM32 20170517 BEGIN --
#if defined(CONFIG_BSP_HW_SKU_8100)
	client_data->gpio_pin = 66;
#else
	client_data->gpio_pin = 60;
#endif
//-->[SM32][Sensors][JasonHsing] Change G-sensor pin config for SM32 20170517 END --
