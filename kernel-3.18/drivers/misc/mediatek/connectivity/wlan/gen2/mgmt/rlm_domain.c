 ...
 */
//[SM32][RaymondLin]Feature:RID005840 - begin 
static const UINT_16 g_u2CountryGroup0[] = {
	...
	COUNTRY_CODE_GW, COUNTRY_CODE_RKS, COUNTRY_CODE_LY,
...
//[SM32][RaymondLin]Feature:RID005840 - end
...
static const UINT_16 g_u2CountryGroup7[] = {
	COUNTRY_CODE_IL, COUNTRY_CODE_KW, COUNTRY_CODE_MA,
...
static const UINT_16 g_u2CountryGroup22[] = {
	COUNTRY_CODE_RU, COUNTRY_CODE_BY, COUNTRY_CODE_KZ, COUNTRY_CODE_AM,
	COUNTRY_CODE_KG
};
	 ...
	 (PUINT_16) g_u2CountryGroup22, sizeof(g_u2CountryGroup22) / 2,
{
	  ...
	  {121, BAND_5G, CHNL_SPAN_20, 132, 4, TRUE}
	  ,			/* CH_SET_UNII_WW_132_144 */
	  {125, BAND_5G, CHNL_SPAN_20, 149, 6, FALSE}
	  ,			
	  {0, BAND_NULL, 0, 0, 0, FALSE}
	 }
	}
