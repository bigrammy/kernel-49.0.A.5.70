...
struct ieee80211_channel *kalP2pFuncGetChannelEntry(IN P_GL_P2P_INFO_T prP2pInfo, IN P_RF_CHANNEL_INFO_T prChannelInfo)
{
	...
	do {
		...
		//[SM31][RaymondLin]Fix DMS09527539 kernel panic issue begin
		 if((BAND_5G == prChannelInfo->eBand)&&(NULL == bands[IEEE80211_BAND_5GHZ]))
		 	break;
		 //[SM31][RaymondLin]Fix DMS09527539 kernel panic issue end
