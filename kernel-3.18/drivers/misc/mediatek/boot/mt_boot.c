...
//[SM32][RaymondLin]Add lcm_vendor information to distinguish LCM vendor -begin
#include <mt-plat/mt_gpio.h>
#define GPIO_LCM_ID_PIN 76
//[SM32][RaymondLin]Add lcm_vendor information to distinguish LCM vendor -end
