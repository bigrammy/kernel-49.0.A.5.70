...
#include "ov13855bmipiraw_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "OV13855B_camera_sensor"
#define LOG_INF(format, args...)	pr_err(PFX "[%s] " format, __FUNCTION__, ##args)

#define LOG_1 LOG_INF("OV13855B,MIPI 4LANE\n")
...
//[SM32][Camera]Add Camera EEPROM driver Person Liu 20170515 S
extern int read_ov13855_eeprom_mtk_fmt(void);
//[SM32][Camera]Add Camera EEPROM driver Person Liu 20170515 E
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV13855B_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
{{ 4224, 3136,  0, 4, 4224, 3136, 2112, 1568, 0, 0, 2112, 1568, 0, 0, 2112, 1568}, // Preview 
 { 4224, 3136, 12, 4, 4224, 3136, 4224, 3136, 0, 0, 4224, 3136, 0, 0, 4224, 3136}, // capture 
 { 4224, 3136, 12, 4, 4224, 3136, 4224, 3136, 0, 0, 4224, 3136, 0, 0, 4224, 3136}, // video
 { 4224, 3136, 832, 848, 2560, 1440, 1280, 720, 0, 0, 1280, 720, 0, 0, 1280, 720},// hight speed video  video
 { 4224, 3136, 832, 848, 2560, 1440, 1280, 720, 0, 0, 1280, 720, 0, 0, 1280, 720}};// slim video 
#if 0
//add for ov13855b pdaf
...
//[SM32][Camera] Modify for sony shutter speed feature Person Liu 20170814 S
    kal_uint32 line_length = 1122;    
//[SM32][Camera] Modify for sony shutter speed feature Person Liu 20170814 E
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	LOG_INF("gain2reg real gain = %d",gain);
	...
	if(iReg > 0x7f0)
	{
		...
		//SENSORDB("[OV13855BGain2Reg]: isp gain:%d,sensor gain:0x%x\n",iGain,iReg);

	return iReg;//ov13855B. sensorGlobalGain
}
...
static void sensor_init(void)
{
    LOG_INF("E\n");
		...
		write_cmos_sensor(0x3681, 0x50);//;60
		write_cmos_sensor(0x3682, 0x50);//;17
		write_cmos_sensor(0x3683, 0xa9);
		write_cmos_sensor(0x3684, 0xa9);//;9a
		write_cmos_sensor(0x3709, 0x5f);//;68
		...
		write_cmos_sensor(0x5000, 0xe9);//Modify for using platform lsc
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    kal_uint8 i = 0;
    kal_uint8 retry = 2;
    int eeprom_check =0;//[SM32][Camera]Add Camera EEPROM driver Person Liu 20170516
        ...
        do {
            *sensor_id = return_sensor_id();
            ...
            if (*sensor_id == 0xD855) {
                ...
                //[SM32][Camera]Add Camera EEPROM driver Person Liu 20170516 S
		  eeprom_check = read_ov13855_eeprom_mtk_fmt();
		  if(eeprom_check < 0){
			  LOG_INF("OV13855 Read EEPROM Failed!!!!!!!!!");
			  return ERROR_SENSOR_CONNECT_FAIL;
		  }
                //[SM32][Camera]Add Camera EEPROM driver Person Liu 20170516 S
                if(eeprom_check == 0x42){
        		  *sensor_id = 0xD856;
                	  LOG_INF("OV13855 Use BYD Module!!!!!!!!!");
                	  return ERROR_NONE;
                }            	
		  else{//Main source Truly module id = 0x02
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
            ...
            //PDAF capacity enable or not, ov13855B only full size support PDAF
            switch (*feature_data) {
                case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
...
UINT32 OV13855B_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    OV13855B_MIPI_RAW_SensorInit    */
