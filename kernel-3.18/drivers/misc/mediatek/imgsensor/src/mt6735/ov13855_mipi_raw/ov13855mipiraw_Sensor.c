...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if(iReg > 0x7f0)
	{
		...
		//SENSORDB("[OV13855Gain2Reg]: isp gain:%d,sensor gain:0x%x\n",iGain,iReg);
        ...
        do {
            *sensor_id = return_sensor_id();
			...
			if(eeprom_check < 0){
                ...
                //[SM32][Camera]Add Camera EEPROM driver Person Liu 20170516 E
                //[SM32][Camera]Modify for Camera 2nd source Person Liu 20170703 S
                if(eeprom_check == 0x2){
                		LOG_INF("OV13855 Use Truly Module!!!!!!!!!");
                return ERROR_NONE;
            }
		  else{//2nd source BYD module id = 0x42
