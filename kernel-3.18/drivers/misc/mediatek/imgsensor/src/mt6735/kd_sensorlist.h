...
// [SM32][Camera][akenhsu] Add Front Camera OV8856 20160511 BEGIN
UINT32 OV8856_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
// [SM32][Camera][akenhsu] 20160511 END
// [SM32][Camera][akenhsu] Add Front Camera 2nd Source OV8857 20160707 BEGIN
UINT32 OV8857_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
// [SM32][Camera][akenhsu] 20160707 END
...
/*S5K*/
//[SM31][Camera] Add Main Camera Driver S5K3L8 Person Liu 20161002 S
UINT32 S5K3L8_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
//[SM31][Camera] Add Main Camera Driver S5K3L8 Person Liu 20161002 E
//[SM31][Camera] Add Main Camera Driver S5K3L8 Person Liu 20170214 S
UINT32 S5K3L8S_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
//[SM31][Camera] Add Main Camera Driver S5K3L8 Person Liu 20170214 E
//[SM31][Camera] Add MainCamear 3rd source Person liu 20170317 S
UINT32 S5K3L8S2_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
//[SM31][Camera] Add MainCamear 3rd source Person liu 20170317 E
...
UINT32 S5K5E2YB_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
//[SM32][Camera]Add Main Camera OV13855 Driver PersonLiu 20170506 E
//[SM32][Camera]Add Main Camera 2nd soure Driver PersonLiu 20170703 S
#if defined(OV13855B_MIPI_RAW)
    {OV13855B_SENSOR_ID, SENSOR_DRVNAME_OV13855B_MIPI_RAW,OV13855B_MIPI_RAW_SensorInit},
#endif
//[SM32][Camera]Add Main Camera 2nd soure Driver PersonLiu 20170703 E
...
#endif
// [SM32][Camera][akenhsu] 201605011END
// [SM32][Camera][akenhsu] Add Front Camera OV8857 20160707 BEGIN
	#if defined(OV8857_MIPI_RAW)
	    {OV8857_SENSOR_ID, SENSOR_DRVNAME_OV8857_MIPI_RAW,OV8857_MIPI_RAW_SensorInit},
	#endif
// [SM32][Camera][akenhsu] 20160707END
...
//[SM31][Camera] Add Main Camera Driver S5K3L8 Person Liu 20161002 E
//[SM31][Camera] Add Main Camera Driver S5K3L8 Person Liu 20170214 S
#if defined(S5K3L8S_MIPI_RAW)
    {S5K3L8S_SENSOR_ID, SENSOR_DRVNAME_S5K3L8S_MIPI_RAW, S5K3L8S_MIPI_RAW_SensorInit},
#endif
//[SM31][Camera] Add Main Camera Driver S5K3L8 Person Liu 20170214 E
//[SM31][Camera] Add MainCamear 3rd source Person liu 20170317 S
#if defined(S5K3L8S2_MIPI_RAW)
    {S5K3L8S2_SENSOR_ID, SENSOR_DRVNAME_S5K3L8S2_MIPI_RAW, S5K3L8S2_MIPI_RAW_SensorInit},
#endif
//[SM31][Camera] Add MainCamear 3rd source Person liu 20170317 E
...
#endif
// [SM31][Camera][akenhsu] Add 2nd source of Front Camera 20170214 BEGIN
#if defined(S5K5E2YB_MIPI_RAW)
    {S5K5E2YB_SENSOR_ID, SENSOR_DRVNAME_S5K5E2YB_MIPI_RAW, S5K5E2YB_MIPI_RAW_SensorInit},
#endif
// [SM31][Camera][akenhsu] 20170214 END
