...
/*
 * DW9714V voice coil motor driver
 *
 *
 */
...
static void DW9714V_init_drv(void)
{
...
/* ////////////////////////////////////////////////////////////// */
long DW9714V_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int DW9714V_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
...
void DW9714V_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
