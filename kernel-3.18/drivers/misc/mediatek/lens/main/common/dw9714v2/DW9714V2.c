...
/*
 * DW9714V2 voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "DW9714V2_DRV"
...
static int s4AF_WriteReg(u16 a_u2Data)
{
	...
	char puSendCmd[3] = {0x03, ((char)(a_u2Data>>8)&0x3), (char)(a_u2Data & 0xFF)};
...
static void DW9714V2_init_drv(void)
{
	
	char puSendCmd0[2] = {0xed,0xab};//Advanced mode ON
	char puSendCmd1[2] = {0x02,0x01};
	char puSendCmd2[2] = {0x02,0x00};

	char puSendCmd3[2] = {0x06,0x84};//SAC3
	char puSendCmd4[2] = {0x07,0x01};
	char puSendCmd5[2] = {0x08,0x41};//SAC Tvib = 9.54ms
...
/* ////////////////////////////////////////////////////////////// */
long DW9714V2_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int DW9714V2_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	char puSendCmd0[2] = {0x80,0x00}; /* Power down mode */
	LOG_INF("Start\n");

	if (*g_pAF_Opened == 2) {
	char puSendCmd1[2] = {0x09,0x5F}; /* NRC land */
	char puSendCmd2[2] = {0x06,0xF0};
	char puSendCmd3[2] = {0x0A,0x03};
/*
...
void DW9714V2_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
