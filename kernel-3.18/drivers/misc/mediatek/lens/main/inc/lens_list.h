...
#endif
//[SM32][Camera]Add DW9714V AF Driver PersonLiu 20170525 S
#ifdef CONFIG_MTK_LENS_DW9714V_SUPPORT
#define DW9714V_SetI2Cclient DW9714V_SetI2Cclient_Main
#define DW9714V_Ioctl DW9714V_Ioctl_Main
#define DW9714V_Release DW9714V_Release_Main
extern void DW9714V_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long DW9714V_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9714V_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
//[SM32][Camera]Add DW9714V AF Driver PersonLiu 20170525 E

//[SM32][Camera]Add DW9714V2 AF Driver PersonLiu 20170703 S
#ifdef CONFIG_MTK_LENS_DW9714V2_SUPPORT
#define DW9714V2_SetI2Cclient DW9714V2_SetI2Cclient_Main
#define DW9714V2_Ioctl DW9714V2_Ioctl_Main
#define DW9714V2_Release DW9714V2_Release_Main
extern void DW9714V2_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long DW9714V2_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9714V2_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
//[SM32][Camera]Add DW9714V2 AF Driver PersonLiu 20170703 E
