...
/*[Arima_8103][bozhi_lin] support type-c 1.5A and 3A pd charger and set current to 1.5A 20170725 begin*/
/*[Arima_8100][bozhi_lin] support type-c pd charger and set current to 1.5A 20161222 begin*/
			#if defined(CONFIG_TCPC_CLASS)
			{
				uint8_t cc1;
			...
			#endif
/*[Arima_8100][bozhi_lin] 20161222 end*/
/*[Arima_8103][bozhi_lin] 20170725 end*/
/*[Arima_8103][bozhi_lin] support type-c 1.5A and 3A pd charger and set current to 1.5A 20170725 begin*/
/*[Arima_8103][bozhi_lin] TUSB320 TypeC support pd charger and set current to 1.5A 20170511 begin*/
			#if defined(CONFIG_USB_C_SWITCH_TUSB320)
			{
				...
				if (current_mode == TYPEC_CURRENT_MODE_HIGH) {
					battery_log(BAT_LOG_CRTI, "step A1_1 : Suppose is Type-C 3A PD Charger\r\n");
					is_dcp_type = true;
					CHR_Type_num = STANDARD_CHARGER;
					battery_log(BAT_LOG_CRTI, "step A1_1 : STANDARD CHARGER!\r\n");
