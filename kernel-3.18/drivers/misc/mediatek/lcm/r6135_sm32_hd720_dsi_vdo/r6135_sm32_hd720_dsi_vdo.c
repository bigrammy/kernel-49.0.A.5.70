...
#define   LCM_HBP_NUM		(100)  
#define   LCM_HFP_NUM		(103) 
...
static struct LCM_setting_table lcm_init_setting[] = 
{
 ...
 //[SM31][RaymondLin]Fix LCM horizontal white line issue end 
  ...
  {0xC1,22,{0x0B,0x6F,0x01,0x80,0x00,0x00,0x00,0x00,0x00,0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 }},
  {0xC3,1,{ 0x75 }},
...
//#VPLVL/VNLVL setting
{0xD5,2,{ 0x24,0x24 }},
{0xD8,4,{0x24,0x66,0x44,0x84 }},//Align FW/BW rising with CK rising
{0x35,1,{ 0x00 }},
//[SM32][RaymondLin]LCM dp run Reverse 180 degree begin 
//[SM32][RaymondLin]Demo App LCM abnormal workaround begin  
{0x36,1,{ 0x03 }},
//[SM32][RaymondLin]Demo App LCM abnormal workaround end  
//[SM32][RaymondLin]LCM dp run Reverse 180 degree end
{0x51,1,{ 0xFF }},
{0x53,1,{ 0x2C }},
{0x55,1,{ 0x01 }},
#endif
...
LCM_DRIVER r6135_sm32_hd720_dsi_vdo_lcm_drv = 
{
    .name			= "r6135_sm32_hd720_dsi_vdo",
