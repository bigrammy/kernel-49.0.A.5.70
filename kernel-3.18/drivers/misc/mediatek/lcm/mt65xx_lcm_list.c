...
//[SM31][Raymond Lin] LCM porting  begin
#if defined(R6135_HD720_DSI_VDO)
	&r6135_hd720_dsi_vdo_lcm_drv,
#endif
//[SM31][Raymond Lin] LCM porting  end

//[SM31][Raymond Lin] Truly OPT LCM begin
#if defined(R6135OTP_HD720_DSI_VDO)
	&r6135otp_hd720_dsi_vdo_lcm_drv,
#endif
//[SM31][Raymond Lin] Truly OPT LCM end
...
//[SM32][Raymond Lin] LCM pdp porting  begin
#if defined(R6135_SM32_PDP_HD720_DSI_VDO)
	&r6135_sm32_pdp_hd720_dsi_vdo_lcm_drv,
#endif
//[SM32][Raymond Lin] LCM pdp porting  end

//[SM32][Raymond Lin] LCM dp run porting  begin
#if defined(R6135_SM32_HD720_DSI_VDO)
	&r6135_sm32_hd720_dsi_vdo_lcm_drv,
#endif
//[SM32][Raymond Lin] LCM dp run porting  end

//[SM32][Raymond Lin] LCM 2nd source porting  begin
#if defined(ILI9881C_SM32_HD720_DSI_VDO)
	&ili9881c_sm32_hd720_dsi_vdo_lcm_drv,
#endif
//[SM32][Raymond Lin] LCM 2nd source porting  end
